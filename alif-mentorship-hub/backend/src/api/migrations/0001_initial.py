# Generated by Django 5.2.7 on 2026-04-16 10:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('university', 'University'), ('scholarships', 'Scholarships'), ('career', 'Career'), ('student_life', 'Student Life')], max_length=20)),
                ('body', models.TextField()),
                ('published_at', models.DateTimeField()),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resources', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('session', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='review', to='api.session')),
            ],
        ),
    ]
